app.controller("account-ctrl",function($scope,$http,$location){
    ...
    $scope.initialize = function(){
		...
		//load authorities of staffs and Admin
	...
	$scope.getOneByRole = function(username){
		$http.get(`/rest/authorities/authoritiesOne?username=${username}`).then(resp=>{
			$scope.selection = [];
    ...
    $scope.update = function(){
		...
		$http.put(`/rest/accounts/${item.username}`,item).then(resp=>{
			...
			$http.delete(`/rest/authorities/authoritiesOne/${item.username}`).then(resp=>{
